---
title: "10X Single Cell RNA-sequencing Practical"
output: 
  word_document:
  fig_caption: yes
  header-includes:
...
In this practical, we will use a bioinformatics pipeline to analyze 10X single cell RNA-sequencing (scRNA-seq) data starting from a count matrix. We will cover the following steps of the analysis:
1. Quality control
2. Normalization
3. Feature selection
